...
print( 'number("two thousand five hundred and eight"):',
        number("two thousand five hundred and eight"))
print( 'number("two point eighty-five"):',
        number("two point eighty-five"))
print("")

# The numerals() command returns a written representation from an int or float.
print( 'numerals(1.249, round=2):', numerals(1.249, round=2))
print( 'numerals(1.249, round=3):', numerals(1.249, round=3))
print("")
...
print( 'quantify(["bunny rabbit"] + reflect([False, True], quantify=False)):',
        quantify(["bunny rabbit"] + reflect([False, True], quantify=False)))
